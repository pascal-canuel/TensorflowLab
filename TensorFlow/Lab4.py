...
train on more data
regularization: the optimization will focus on the most prominents patterns, that have a chance to generalize well
***
'''
...
Intuitively, a model with more parameters will have more "memorization capacity" and therefore will be able 
to easily learn a perfect dictionary-like mapping between training samples and their targets, a mapping without any generalization power, 
...
# *** large network overfit quickly because it can model the training data ***

'''
***
a common way to mitigate overfitting is to put constraints on the complexity 
of a network by forcing its weights only to take small value, which makes the distribution of weight values more "regular"
***
?????
'''
